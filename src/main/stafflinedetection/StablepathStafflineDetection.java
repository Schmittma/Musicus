package main.stafflinedetection;
...
public class StablepathStafflineDetection implements StafflineDetection {
    ...
    class PathCheckerThread implements Runnable {
        ...
        public PathCheckerThread(Graph<Integer, DefaultWeightedEdge> graph, int threadY, int xLength, int yLength) {
            super();
        ...
        public void run() {
            ...
            System.out.println("I am the thread for y = " + threadY + " and finished. shortest path: " + minWeight + "| Exectime: " +
