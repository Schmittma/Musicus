...
public final class ImageConverter {
    ...
    /**
     * Converts a BufferedImage into a 2D-{@linkplain main.java.general.Color Color} array in the order [X][Y]
     *
     * @param inputImage the BufferedImage to be converted
     * @return a 2D-{@linkplain main.java.general.Color Color} array
     */
